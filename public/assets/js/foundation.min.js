...
!(function (t) {
        ...
        var s = i(0),
            ...
            r = {
                ...
                _init: function () {
                    ...
                    var i,
                        s = o()(".foundation-mq").css("font-family");
                    i = n(s);
                    for (var a in i)
                        i.hasOwnProperty(a) &&
                            t.queries.push({
                ...
                _watcher: function () {
                    ...
                    o()(window)
                        ...
                        .on("resize.zf.mediaquery", function () {
                            ...
                            e !== i &&
                                ((t.current = e),
                                o()(window).trigger("changed.zf.mediaquery", [
                                    e,
                                    i,
                                ]));
                        });
        ...
        function a(t, e, n, s, o, a) {
            switch (
                ...
                case "reveal":
                    return {
                        left:
                            ($eleDims.windowDims.width - $eleDims.width) / 2 +
                            o,
                ...
                case "bottom":
                    switch (n) {
                        ...
                        case "center":
                            u = r
                                ? a
                                : h.offset.left + h.width / 2 - c.width / 2 + a;
                    }
                    break;
                case "right":
                case "left":
        ...
        (m.setupSpotSwipe = function (t) {
            ...
            (m.init = function (t) {
                "undefined" == typeof t.spotSwipe &&
                    (m.setupSpotSwipe(t), m.setupTouchHandler(t));
            });
    },
    function (t, e, i) {
        "use strict";
                    ...
                    u(e, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                e.length &&
                                    e.addClass(this.options.labelErrorClass),
                                    i.length &&
                                        i.addClass(this.options.formErrorClass),
                                    t
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                i.length &&
                                    i.removeClass(this.options.labelErrorClass),
                                    n.length &&
                                        n.removeClass(
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                var e = this.findLabel(t),
                                    i = this.findFormError(t);
                                e.length &&
                                    e.removeClass(this.options.labelErrorClass),
                                    i.length &&
                                        i.removeClass(
                                            this.options.formErrorClass
                                        ),
    ...
    function (t, e, i) {
        ...
        function s(t) {
            return (
                "true" === t ||
                ("false" !== t && (isNaN(1 * t) ? t : parseFloat(t)))
            );
        }
        function o(t) {
            return t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
                ...
                return (
                    ...
                    d(e, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t =
                                        this.$element.attr("data-equalizer") ||
                                        "",
                                    e = this.$element.find(
                                ...
                                l.a._init(),
                                    ...
                                    (this.hasNested =
                                        this.$element.find("[data-equalizer]")
                                            .length > 0),
                                    (this.isNested =
                        ...
                        { key: "_killswitch", value: function () {} },
                        {
                            key: "_reflow",
                            value: function () {
                                return !this.options.equalizeOnStack &&
                                    this._isStacked()
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                for (
                                    var e = [], i = 0, n = this.$watched.length;
                                    i < n;
                                    i++
                                )
                            ...
                            value: function () {
                                ...
                                for (var e in this.rules)
                                    if (this.rules.hasOwnProperty(e)) {
                                        var i = this.rules[e];
                                        window.matchMedia(i.query).matches &&
                                            (t = i);
                                    }
                        ...
                        },
                        {
                            ...
                            value: function () {
                                if (
                                    ...
                                    var t =
                                        this.$active[0].getAttribute("href");
                            ...
                            value: function () {
                                ...
                                if (
                                    ...
                                    var e = document.createElement("div"),
                                        i =
                                            "fixed" ===
                                            r()(this.$element).css("position")
                                                ? "is-overlay-fixed"
                                                : "is-overlay-absolute";
                                    e.setAttribute(
                                        "class",
                                        "js-off-canvas-overlay " + i
                                    ),
                                        (this.$overlay = r()(e)),
                                        "is-overlay-fixed" === i
                                            ? r()(this.$overlay).insertAfter(
                                                  this.$element
                                              )
                                            : this.$content.append(
                                                  this.$overlay
                ...
                return (
                    ...
                    f(e, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                if (
                                    (l.a._init(), "string" == typeof this.rules)
                                ) {
                                    for (
                                        var t = {},
                                            e = this.rules.split(" "),
                            ...
                            value: function () {
                                ...
                                this.$element &&
                                    ((this.focusableElements =
                                        h.a.findFocusable(this.$element)),
                                    this.options.overlay ||
                                        !this.options.closeOnClick ||
                                        this.options.fullScreen ||
                                        c()("body").on(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                function t() {
                                    e.isMobile
                                        ? (0 ===
                                              c()(".reveal:visible").length &&
                                              c()("html, body").removeClass(
                                                  "is-reveal-open"
                                              ),
                                          e.originalScrollPos &&
                                              (c()("body").scrollTop(
                ...
                return (
                    ...
                    v(e, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return (
                                    (Math.pow(this.options.nonLinearBase, t) -
                                        1) /
                        ...
                        },
                        {
                            ...
                            value: function (t, e, n) {
                                var s, o;
                                if (n)
                                    (s = this._adjustValue(null, n)), (o = !0);
                                else {
                                    t.preventDefault();
                                    var l = this,
    ...
    function (t, e, i) {
        ...
        o.a.addToJquery(s.a),
            (o.a.MediaQuery = a.a),
            r.a.init(s.a, o.a),
            o.a.plugin(l.a, "Abide"),
            o.a.plugin(u.a, "Accordion"),
            o.a.plugin(c.a, "AccordionMenu"),
            o.a.plugin(h.a, "Drilldown"),
            o.a.plugin(d.a, "Dropdown"),
            o.a.plugin(f.a, "DropdownMenu"),
            o.a.plugin(p.a, "Equalizer"),
            o.a.plugin(m.a, "Interchange"),
            o.a.plugin(g.a, "Magellan"),
            o.a.plugin(v.a, "OffCanvas"),
            o.a.plugin(b.a, "Orbit"),
            o.a.plugin(y.a, "ResponsiveMenu"),
            o.a.plugin(w.a, "ResponsiveToggle"),
            o.a.plugin(_.a, "Reveal"),
            o.a.plugin($.a, "Slider"),
            o.a.plugin(k.a, "Sticky"),
            o.a.plugin(C.a, "Tabs"),
            o.a.plugin(z.a, "Toggler"),
            o.a.plugin(O.a, "Tooltip"),
            o.a.plugin(T.a, "ResponsiveAccordionTabs");
    },
]);
