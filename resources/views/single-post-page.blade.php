                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="blog-detail-content">
                            <img src="assets/images/help/blog/blog-img1.jpg" alt="Blog Image"
                                class="img-fluid rounded mb-4">

                            <h2 class="mb-3">Skin Care That Actually Works</h2>
                            <p>Posted by admin | 25 September 2022</p>

                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                                been the industry's standard dummy text ever since the 1500s.
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. A reiciendis accusantium
                                dignissimos amet exercitationem rerum.</p>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                                been the industry's standard dummy text ever since the 1500s.
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae dicta dolorum culpa eum
                                totam, praesentium aut odit doloribus tempore eos.</p>
                    ...
                    <div class="col-lg-3">
                        <div class="related-blogs">
                            ...
                            <div class="d-flex mb-4">
                                <img src="http://placehold.co/100x100" alt="Blog 1" class="img-fluid rounded me-3"
                                    style="width: 80px; height: 80px; object-fit: cover;">
                                <div>
                                    <h6 class="mb-1">The Benefits of Aloe Vera</h6>
                                    <p class="mb-0 text-muted" style="font-size: 0.9rem;">Discover how Aloe Vera can </p>
                                </div>
                            </div>

                            <div class="d-flex mb-4">
                                <img src="http://placehold.co/100x100" alt="Blog 2" class="img-fluid rounded me-3"
                                    style="width: 80px; height: 80px; object-fit: cover;">
                                <div>
                                    <h6 class="mb-1">Nighttime Skin Rituals</h6>
                                    <p class="mb-0 text-muted" style="font-size: 0.9rem;">Simple habits before bed for
                                        healthy, glowing skin.</p>
                                </div>
                            </div>

                            <div class="d-flex">
                                <img src="http://placehold.co/100x100" alt="Blog 3" class="img-fluid rounded me-3"
                                    style="width: 80px; height: 80px; object-fit: cover;">
                                <div>
                                    <h6 class="mb-1">Hydration Tips</h6>
                                    <p class="mb-0 text-muted" style="font-size: 0.9rem;">Why water is your skin’s best
                                        friend and how to drink enough daily.</p>
                                </div>
                            </div>
