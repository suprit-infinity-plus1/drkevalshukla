                            ...
                            <div class="conditions-treated-contaner">
                                <div class="row text-center">
                                    <div class="col-md-4 mb-3">
                                        <div class="border p-3 rounded-3 h-100">
                                            <p class="mb-0 text-center fw-semibold">
                                                Drug-resistant epilepsy (focal or generalized)
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border p-3 rounded-3 h-100">
                                            <p class="mb-0 text-center fw-semibold">
                                                Epilepsy due to cortical malformations or tumors
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border p-3 rounded-3 h-100">
                                            <p class="mb-0 text-center fw-semibold">
                                                Seizures from past brain trauma or infections
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        ...
                                        <span>
                                            ...
                                            (removal of tumors, cysts, or scar tissue)
                                        </span>
                                    </div>
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        <span class="me-2" style="color: #ff4500; font-size: 1.1rem;">✔</span>
                                    ...
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        ...
                                        <span>
                                            <span class="fw-semibold">
                                                SEEG & Electrocorticography
                                            </span>
                                            for precise brain mapping
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="p-4 bg-white rounded shadow-sm border-start border-4"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        <span class="me-2" style="color: #ff4500; font-size: 1.1rem;">✔</span>
                                        <span>Reduced medication dependency
                                        </span>
                                    </div>
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        <span class="me-2" style="color: #ff4500; font-size: 1.1rem;">✔</span>
                                        <span>Improved memory, behavior, and quality of life</span>
                                    </div>
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        <span class="me-2" style="color: #ff4500; font-size: 1.1rem;">✔</span>
                                        <span>Increased independence in daily life</span>
                                    </div>
                                    <div class="col-12 mb-2 d-flex justify-content-start align-items-start">
                                        <span class="me-2" style="color: #ff4500; font-size: 1.1rem;">✔</span>
                                        <span>Safer pregnancy and parenting for women with epilepsy</span>
                                    </div>
